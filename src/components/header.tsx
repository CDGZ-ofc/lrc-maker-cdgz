...
import { CloudSVG, EditorSVG, HomeSVG, KeyBindingsSVG, PreferencesSVG, SynchronizerSVG } from "./svg.js";
    ...
    return (
        <header className="app-header">
            ...
            <nav className="app-nav">
                ...
                <a
                    id={ROUTER.keybindings}
                    className="app-tab"
                    title={lang.header.keybindings}
                    href={prependHash(ROUTER.keybindings)}
                >
                    <KeyBindingsSVG />
                </a>
            </nav>
