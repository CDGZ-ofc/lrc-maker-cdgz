...
export const AsidePanel: React.FC<{
    ...
    const onDecreaseOffset = useCallback(() => {
        lrcDispatch({
            type: ActionType.offsetAll,
            payload: -prefState.fineTuneOffset / 1000,
        });
    }, [lrcDispatch, prefState.fineTuneOffset]);

    const onIncreaseOffset = useCallback(() => {
        lrcDispatch({
            type: ActionType.offsetAll,
            payload: prefState.fineTuneOffset / 1000,
        });
    ...
    return (
        <aside className="aside-panel">
            ...
            <button className="aside-button ripple glow" onClick={onDecreaseOffset} aria-label="Decrease offset">
                <ArrowLeftSVG />
            </button>
            <button className="aside-button ripple glow" onClick={onIncreaseOffset} aria-label="Increase offset">
                <ArrowRightSVG />
            </button>
